...
CR_REG_METADATA(CGame, (
	...
	CR_MEMBER(showClock),
	CR_MEMBER(showSpeed),
	CR_IGNORED(validationRenderCapture),
	CR_IGNORED(validationRenderCaptureHideInterface),
	CR_IGNORED(validationRenderCaptureCenterCamera),
	CR_IGNORED(validationRenderCapturePlayerStartCamera),
	CR_IGNORED(validationRenderCaptureSceneOnly),
	CR_IGNORED(validationRenderCaptureHideCursor),
	CR_IGNORED(validationRenderCapturePrepared),
	CR_IGNORED(validationRenderCaptured),
	CR_IGNORED(validationRenderCaptureFrame),
	CR_IGNORED(validationRenderCaptureCameraHeight),
	CR_IGNORED(validationRenderCaptureCameraBackOffset),
