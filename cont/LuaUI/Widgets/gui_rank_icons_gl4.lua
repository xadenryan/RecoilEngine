...
if isMacOS then
	return loader.BuildMacOSFallbackWidget({
		name = "Rank Icons GL4",
		desc = "Disable SSBO-backed rank icons on macOS",
		warning = "[BAR widget proxy] disabling Rank Icons GL4 on macOS because Apple OpenGL 4.1 does not support the required SSBO shader path",
	})
end

return loader.LoadPatchedModWidget(
	getfenv(1),
	LUAUI_DIRNAME .. "Widgets/gui_rank_icons_gl4.lua",
	nil,
	"load original Rank Icons GL4 widget"
)
